...
const messages={
    ...
    developer: 'Developer',
    dashboard: {
        personal_information: 'Manage you personal information, accounts and review your security settings.',
        review_manage: 'Review and manage your accounts',
        manage_accounts: 'Manage Accounts',
        view_update: 'View and update your credentials',
        edit_profile: 'Edit profile',
        active_sessions: 'You have currently active sessions on one or more devices.',
    ...
    account_page:{
        ...
        delete_account_info: "Remove your account and all the associated information",
        delete: "Delete",
        ...
        update_account: 'Update account credentials'
    },
    edit_password:{
        password: 'Password',
    ...
    error:{
        ...
        authentication_service: 'Authentication problem. Please try again later.',
        ...
        invalid_password: {
            ...
            require_uppercase_alpha: 'Invalid password: uppercase alpha char required',
